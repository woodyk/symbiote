...
# Define the controls
controls = ['UP: Increase noise', 'DOWN: Decrease noise', 'LEFT: Previous channel', 'RIGHT: Next channel', 'C: Change contour color']
...
while running:
    ...
    cv2.drawContours(gray_data, contours, -1, contour_color, 3)
